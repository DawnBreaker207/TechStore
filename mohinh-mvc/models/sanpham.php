<?php
    ...
    function insert_sanpham($ten_sp, $img, $gia, $mota, $ma_nsx, $ma_dm){
        $sql = "INSERT INTO sanpham( ten_sp, img, gia, mota, ma_nsx, ma_dm) VALUES (?,?,?,?,?,?)";
        return getData($sql, [$ten_sp, $img, $gia, $mota, $ma_nsx, $ma_dm], false);
    }
